...
Revision ID: 21500e23657f
Revises: 
Create Date: 2021-08-27 03:47:52.833093
...
def upgrade():
    ...
    sa.Column('register', sa.String(length=120), nullable=False),
    sa.Column('perfil', sa.String(length=120), nullable=False),
    sa.Column('fecha_nacimiento', sa.String(length=200), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
